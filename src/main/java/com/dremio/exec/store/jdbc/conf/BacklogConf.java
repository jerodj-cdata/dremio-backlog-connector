...
@SourceType(value = "BacklogARP", label = "Backlog",uiConfig = "backlog-layout.json")
public class BacklogConf extends AbstractArpConf<BacklogConf> {
  private static final String ARP_FILENAME = "arp/implementation/backlog-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.backlog.BacklogDriver";
